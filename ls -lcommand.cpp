...
//
// This is a function that will take as input a number that has the user's 
// time information stored, and will turn that number into a readable timestamp 
// string using localtime() and strftime() functions that displays the last modified
// timeline.
//
// INPUT: time_t value
//
